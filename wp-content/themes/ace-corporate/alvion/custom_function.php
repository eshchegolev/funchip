...
/*
 * Вызов моей кастомной части тимплейта
 */
...
function wpschool_api_add_admin_menu( ) {
	add_menu_page( 'Преимущества', 'Преимущества', 'manage_options', 'wpschool-settings-page', 'wpschool_api_options_page' );
}
...
function create_goods() {
    register_post_type('goods', array(
        'labels' => array(
            ...
            'add_new'         => __( 'Добавить товар' ),
            'add_new_item'    => __( 'Добавить товар' ),
            'edit'            => __( 'Редактировать товар' ),
                            ...
                            <div class="blog-content-image effect-thumb" >
                                <article id="post-1">
                                    <div class="post-content entry-content" >
                                        <div class="featured-image archive-thumb" style="align: center">
                                            <a title="	<?php the_title(); ?>" href="<?php echo get_post_permalink() ?>" class="post-thumbnail" style="width: 250px; height: auto; margin: 10px auto 10px auto">
...
// Подключается custom.css с собственными стилями
add_action( 'wp_enqueue_scripts', 'child_enqueue_styles');

function child_enqueue_styles() {
    wp_enqueue_style( 'reset-style', get_template_directory_uri() . '/alvion/css/custom.css', array());
}